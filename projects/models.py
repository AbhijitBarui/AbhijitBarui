...
class Project(models.Model):
    ...
    image_1 = models.ImageField(upload_to='projectphotos/%Y/%m/%d/', blank=True)
    image_2 = models.ImageField(upload_to='projectphotos/%Y/%m/%d/', blank=True)
    image_3 = models.ImageField(upload_to='projectphotos/%Y/%m/%d/', blank=True)
